...
import { RepairWorkspacePanel } from "./Phase7Details";
...
export function ChangeCockpit({ projectId, changeId, impactReady, t, onError }: {
  ...
  return <section className="change-cockpit" aria-label={t("cockpit.title")}>
    ...
    <div className="change-grid">
      ...
      {latestRegression && <RepairWorkspacePanel projectId={projectId} regressionId={latestRegression.id} t={t} onError={onError} />}
